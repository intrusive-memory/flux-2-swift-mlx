...
struct FluxTextEncodersGPUTests {
    ...
    @Test(.timeLimit(.minutes(3))) func qwen3EmbeddingShape() async throws {
        ...
        let embeddings = try encoders.extractKleinEmbeddings(prompt: "a red balloon floating in the sky")
        // Klein 4B: [1, 512, 7680]
        ...
        #expect(embeddings.shape[2] == KleinVariant.klein4B.outputDimension,
    ...
    @Test(.timeLimit(.minutes(3))) func kleinEmbeddingsAreDeterministic() async throws {
        ...
        #expect(embeddings1.shape == embeddings2.shape,
