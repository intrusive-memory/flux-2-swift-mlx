...
- [[_COMMUNITY_Text Encoder GPU Tests|Text Encoder GPU Tests]]
- [[_COMMUNITY_Simple LoRA Trainer|Simple LoRA Trainer]]
- [[_COMMUNITY_Core GPU Tests|Core GPU Tests]]
- [[_COMMUNITY_Text Encoder Errors|Text Encoder Errors]]
- [[_COMMUNITY_Caption Dataset Parsing|Caption Dataset Parsing]]
- [[_COMMUNITY_VAE Configuration|VAE Configuration]]
- [[_COMMUNITY_Generation Pipeline & Results|Generation Pipeline & Results]]
- [[_COMMUNITY_Latent Caching|Latent Caching]]
- [[_COMMUNITY_Mistral Attention & KV Cache|Mistral Attention & KV Cache]]
- [[_COMMUNITY_Model Registry|Model Registry]]
- [[_COMMUNITY_Telemetry & Anomaly Tests|Telemetry & Anomaly Tests]]
- [[_COMMUNITY_Hidden States & Weight Loading|Hidden States & Weight Loading]]
- [[_COMMUNITY_RMSNorm Layer|RMSNorm Layer]]
- [[_COMMUNITY_Memory Delta Types|Memory Delta Types]]
- [[_COMMUNITY_Scheduler & Core Tests|Scheduler & Core Tests]]
- [[_COMMUNITY_Training Session & Resume|Training Session & Resume]]
- [[_COMMUNITY_Image Processor Tests|Image Processor Tests]]
- [[_COMMUNITY_LoRA Training Config|LoRA Training Config]]
- [[_COMMUNITY_Mistral VLM Model|Mistral VLM Model]]
- [[_COMMUNITY_Text Encoder Model Registry|Text Encoder Model Registry]]
- [[_COMMUNITY_Embedding Extractor|Embedding Extractor]]
- [[_COMMUNITY_Profiler|Profiler]]
- [[_COMMUNITY_Transformer Config Coding Keys|Transformer Config Coding Keys]]
- [[_COMMUNITY_Model Registry Tests|Model Registry Tests]]
- [[_COMMUNITY_Mistral Model Layers|Mistral Model Layers]]
- [[_COMMUNITY_Qwen3 Configuration|Qwen3 Configuration]]
- [[_COMMUNITY_Training Control Tests|Training Control Tests]]
- [[_COMMUNITY_LoRA Adapter & Manager|LoRA Adapter & Manager]]
- [[_COMMUNITY_Vision Config Coding Keys|Vision Config Coding Keys]]
- [[_COMMUNITY_LoRA Loader|LoRA Loader]]
- [[_COMMUNITY_Beaver Render Prompts|Beaver Render Prompts]]
- [[_COMMUNITY_Latent Utilities|Latent Utilities]]
- [[_COMMUNITY_Tekken Tokenizer|Tekken Tokenizer]]
- [[_COMMUNITY_VAE Resnet Blocks|VAE Resnet Blocks]]
- [[_COMMUNITY_Training Controller|Training Controller]]
- [[_COMMUNITY_Single Transformer Block Attention|Single Transformer Block Attention]]
- [[_COMMUNITY_Memory Manager|Memory Manager]]
- [[_COMMUNITY_LoRA Linear Injection|LoRA Linear Injection]]
- [[_COMMUNITY_Tarot Card Illustrations|Tarot Card Illustrations]]
- [[_COMMUNITY_Image Generation ViewModel|Image Generation ViewModel]]
- [[_COMMUNITY_Quantization Config|Quantization Config]]
- [[_COMMUNITY_Text Encoders Integration Tests|Text Encoders Integration Tests]]
- [[_COMMUNITY_Mistral Generator|Mistral Generator]]
- [[_COMMUNITY_LoRA Config|LoRA Config]]
- [[_COMMUNITY_Telemetry Event Anomalies|Telemetry Event Anomalies]]
- [[_COMMUNITY_Debug Logging|Debug Logging]]
- [[_COMMUNITY_Memory Config & Cache|Memory Config & Cache]]
- [[_COMMUNITY_Model Registry Variant Tests|Model Registry Variant Tests]]
- [[_COMMUNITY_Qwen3 Generator|Qwen3 Generator]]
- [[_COMMUNITY_FeedForward Layers|FeedForward Layers]]
- [[_COMMUNITY_Parallel Attention|Parallel Attention]]
- [[_COMMUNITY_Content & Chat View|Content & Chat View]]
- [[_COMMUNITY_Klein Text Encoder|Klein Text Encoder]]
- [[_COMMUNITY_Chat ViewModel|Chat ViewModel]]
- [[_COMMUNITY_RoPE Embeddings|RoPE Embeddings]]
- [[_COMMUNITY_Transformer Blocks|Transformer Blocks]]
- [[_COMMUNITY_Mock Pipeline & Coverage Tests|Mock Pipeline & Coverage Tests]]
- [[_COMMUNITY_Tokenizer Tests|Tokenizer Tests]]
- [[_COMMUNITY_Flux2 Attention|Flux2 Attention]]
- [[_COMMUNITY_Timestep Embeddings|Timestep Embeddings]]
- [[_COMMUNITY_Modulation Layers|Modulation Layers]]
- [[_COMMUNITY_Project Documentation|Project Documentation]]
- [[_COMMUNITY_Klein Embedding Extractor|Klein Embedding Extractor]]
- [[_COMMUNITY_Checkpoint Image ViewModel|Checkpoint Image ViewModel]]
- [[_COMMUNITY_Transformer Block|Transformer Block]]
- [[_COMMUNITY_Hidden States Config Tests|Hidden States Config Tests]]
- [[_COMMUNITY_Flux2 Model Config|Flux2 Model Config]]
- [[_COMMUNITY_CGImage Roundtrip Tests|CGImage Roundtrip Tests]]
- [[_COMMUNITY_Dev Text Encoder|Dev Text Encoder]]
- [[_COMMUNITY_Klein Config|Klein Config]]
- [[_COMMUNITY_Superhero Render Outputs|Superhero Render Outputs]]
- [[_COMMUNITY_Training State|Training State]]
- [[_COMMUNITY_Image-to-Image Training Tests|Image-to-Image Training Tests]]
- [[_COMMUNITY_Training Pipeline Setup|Training Pipeline Setup]]
- [[_COMMUNITY_MultiModal Projector|MultiModal Projector]]
- [[_COMMUNITY_Generation Result Tests|Generation Result Tests]]
- [[_COMMUNITY_Resumable AdamW Optimizer|Resumable AdamW Optimizer]]
- [[_COMMUNITY_Qwen3 Attention|Qwen3 Attention]]
- [[_COMMUNITY_Telemetry Event Types|Telemetry Event Types]]
- [[_COMMUNITY_Core Extended Tests|Core Extended Tests]]
- [[_COMMUNITY_Configuration Tests|Configuration Tests]]
- [[_COMMUNITY_Model Paths|Model Paths]]
- [[_COMMUNITY_Flux Tools View|Flux Tools View]]
- [[_COMMUNITY_Error Phase Types|Error Phase Types]]
- [[_COMMUNITY_App Lifecycle|App Lifecycle]]
- [[_COMMUNITY_Training Status|Training Status]]
- [[_COMMUNITY_Training Variants Tests|Training Variants Tests]]
- [[_COMMUNITY_Encoder Configuration|Encoder Configuration]]
- [[_COMMUNITY_Quantization Config Tests|Quantization Config Tests]]
- [[_COMMUNITY_Model Error Types|Model Error Types]]
- [[_COMMUNITY_Instrumentation Requirements|Instrumentation Requirements]]
- [[_COMMUNITY_LoRA Training Helper|LoRA Training Helper]]
- [[_COMMUNITY_Transformer KV Cache|Transformer KV Cache]]
- [[_COMMUNITY_Pentacles Tarot Captions|Pentacles Tarot Captions]]
- [[_COMMUNITY_Cat Beach Render Steps|Cat Beach Render Steps]]
- [[_COMMUNITY_LoRA Config Validation Errors|LoRA Config Validation Errors]]
- [[_COMMUNITY_Memory Config Tests|Memory Config Tests]]
- [[_COMMUNITY_Text Encoder Weight Loader|Text Encoder Weight Loader]]
- [[_COMMUNITY_Models Management View|Models Management View]]
- [[_COMMUNITY_VAE Decoder|VAE Decoder]]
- [[_COMMUNITY_Mistral Text Config|Mistral Text Config]]
- [[_COMMUNITY_Scheduler Overrides Tests|Scheduler Overrides Tests]]
- [[_COMMUNITY_Qwen3 Decoder Layer|Qwen3 Decoder Layer]]
- [[_COMMUNITY_Learning Curve SVG Plot|Learning Curve SVG Plot]]
- [[_COMMUNITY_Transformer KV Cache|Transformer KV Cache]]
- [[_COMMUNITY_Lazy Text Encoder Cache|Lazy Text Encoder Cache]]
- [[_COMMUNITY_Cat Toy LoRA Assets|Cat Toy LoRA Assets]]
- [[_COMMUNITY_Image-to-Image Artistic Variation|Image-to-Image Artistic Variation]]
- [[_COMMUNITY_Training Text Encoder|Training Text Encoder]]
- [[_COMMUNITY_Training Controller Observers|Training Controller Observers]]
- [[_COMMUNITY_Tokenizer CDN Migration Op|Tokenizer CDN Migration Op]]
- [[_COMMUNITY_Memory Optimization Config|Memory Optimization Config]]
- [[_COMMUNITY_Training Checkpoint Notifications|Training Checkpoint Notifications]]
- [[_COMMUNITY_Fused Rotary Embedding Kernels|Fused Rotary Embedding Kernels]]
- [[_COMMUNITY_On-the-Fly Quantization Tests|On-the-Fly Quantization Tests]]
- [[_COMMUNITY_MLX Checkpoint Bindings|MLX Checkpoint Bindings]]
- [[_COMMUNITY_Qwen3 Chat View|Qwen3 Chat View]]
- [[_COMMUNITY_Image Drop Handling|Image Drop Handling]]
- [[_COMMUNITY_Reference Image Slots UI|Reference Image Slots UI]]
- [[_COMMUNITY_Timestep Sampling Modes|Timestep Sampling Modes]]
- [[_COMMUNITY_Transformer KV Cache Tests|Transformer KV Cache Tests]]
- [[_COMMUNITY_Vision View Image Loading|Vision View Image Loading]]
- [[_COMMUNITY_LoRA Training Learning Curve|LoRA Training Learning Curve]]
- [[_COMMUNITY_Mistral MLP|Mistral MLP]]
- [[_COMMUNITY_Qwen3 MLP|Qwen3 MLP]]
- [[_COMMUNITY_Training Memory Config|Training Memory Config]]
- [[_COMMUNITY_Text Encoder Memory Config|Text Encoder Memory Config]]
- [[_COMMUNITY_Dev Text Encoder Tests|Dev Text Encoder Tests]]
- [[_COMMUNITY_Flux2 Model Tests|Flux2 Model Tests]]
- [[_COMMUNITY_Gradient Checkpointing Config Tests|Gradient Checkpointing Config Tests]]
- [[_COMMUNITY_Inference Variant Tests|Inference Variant Tests]]
- [[_COMMUNITY_Klein9B KV Config Tests|Klein9B KV Config Tests]]
- [[_COMMUNITY_Klein9B KV Enum Tests|Klein9B KV Enum Tests]]
- [[_COMMUNITY_LoRA Config Tests|LoRA Config Tests]]
- [[_COMMUNITY_Memory Manager Tests|Memory Manager Tests]]
- [[_COMMUNITY_VAE Config Tests|VAE Config Tests]]
- [[_COMMUNITY_Map-to-Paris I2I Example|Map-to-Paris I2I Example]]
- [[_COMMUNITY_Telemetry Reporter|Telemetry Reporter]]
- [[_COMMUNITY_Flux Debug Logging|Flux Debug Logging]]
- [[_COMMUNITY_Watercolor Fox Generation|Watercolor Fox Generation]]
- [[_COMMUNITY_Generation Mode Tests|Generation Mode Tests]]
- [[_COMMUNITY_Klein9B KV Registry Tests|Klein9B KV Registry Tests]]
- [[_COMMUNITY_Transformer Config Tests|Transformer Config Tests]]
- [[_COMMUNITY_Anomaly Check Classifier|Anomaly Check Classifier]]
- [[_COMMUNITY_Tarot LoRA Training Assets|Tarot LoRA Training Assets]]
- [[_COMMUNITY_Test Image Helper|Test Image Helper]]
- [[_COMMUNITY_LoRA Training Helper|LoRA Training Helper]]
- [[_COMMUNITY_Twin Lighthouse Telemetry Audit|Twin Lighthouse Telemetry Audit]]
- [[_COMMUNITY_Bulk Ship Script|Bulk Ship Script]]
- [[_COMMUNITY_Flux2 Telemetry Setup|Flux2 Telemetry Setup]]
- [[_COMMUNITY_Operation Universal Solvent Docs|Operation Universal Solvent Docs]]
- [[_COMMUNITY_Text-to-Image View|Text-to-Image View]]
- [[_COMMUNITY_Generation Mode Enum|Generation Mode Enum]]
- [[_COMMUNITY_Beaver Watercolor Checkpoints|Beaver Watercolor Checkpoints]]
- [[_COMMUNITY_Quantization Benchmark Output|Quantization Benchmark Output]]
- [[_COMMUNITY_Telemetry Surface Audit|Telemetry Surface Audit]]
- [[_COMMUNITY_Fox Photo Checkpoints|Fox Photo Checkpoints]]
- [[_COMMUNITY_Beaver Emoji LoRA Example|Beaver Emoji LoRA Example]]
- [[_COMMUNITY_Multi-Angle Cat LoRA Example|Multi-Angle Cat LoRA Example]]
- [[_COMMUNITY_Object-Removal LoRA Example|Object-Removal LoRA Example]]
- [[_COMMUNITY_Spritesheet LoRA Example|Spritesheet LoRA Example]]
- [[_COMMUNITY_Turbo LoRA Example|Turbo LoRA Example]]
- [[_COMMUNITY_Queen of Swords Tarot|Queen of Swords Tarot]]
- [[_COMMUNITY_King of Swords Tarot|King of Swords Tarot]]
- [[_COMMUNITY_Knight of Swords Tarot|Knight of Swords Tarot]]
- [[_COMMUNITY_Page of Swords Tarot|Page of Swords Tarot]]
...
- [[_COMMUNITY_Four of Swords Caption|Four of Swords Caption]]
- [[_COMMUNITY_Three of Swords Caption|Three of Swords Caption]]
- [[_COMMUNITY_Two of Swords Caption|Two of Swords Caption]]
- [[_COMMUNITY_Ace of Swords Caption|Ace of Swords Caption]]
- [[_COMMUNITY_King of Cups Caption|King of Cups Caption]]
- [[_COMMUNITY_Queen of Cups Caption|Queen of Cups Caption]]
- [[_COMMUNITY_Knight of Cups Caption|Knight of Cups Caption]]
...
6. `Task` - 34 edges
7. `ImageGenerationViewModel` - 33 edges
8. `TrainingController` - 33 edges
9. `CodingKeys` - 30 edges
...
- `Process-wide Telemetry Seam TODO` --conceptually_related_to--> `Telemetry Instrumentation Requirements`  [INFERRED]
  docs/TODO-vinetas-cli-telemetry-seam.md → REQUIREMENTS-instrumentation.md
- `Multi-Image I2I: Cat + Hat + Jacket` --references--> `Cat Beach Standard — Step 28 (final: tabby cat in sunglasses on sunny beach)`  [INFERRED]
...
Cohesion: 0.07
Nodes (38): AspectRatioBucketManager, CaptionParser, CaptionParserError, captionFileNotFound, invalidEncoding, invalidJSON, metadataFileNotFound, missingField (+30 more)

### Community 5 - "VAE Configuration"
Cohesion: 0.05
...
Cohesion: 0.17
Nodes (11): HiddenStatesConfig, KleinConfig, KleinVariant, klein4B, klein9B, Mode, embeddings, upsamplingI2I (+3 more)

### Community 82 - "Flux Tools View"
Cohesion: 0.19
...
- `Cat-Hat-Jacket I2I Final Step 28 (cat in hat and jacket on beach)` → `Beaver Building a Dam (1024x1024 T2I)`  [AMBIGUOUS]
